...
智力不再是稀缺资源。它像自来水一样，打开水龙头就有。

### LLM + 图灵机 = ?

这是一个值得深思的等式：

> **LLM（大语言模型）+ 图灵机（计算机）= 任何人都能拥有一支无限规模的智能团队**

- **LLM** 提供了理解、推理、创作的能力
- **图灵机** 提供了 7×24 小时不间断执行的能力
- **两者结合**，意味着你可以把任何可描述的任务委托出去
...
过去，**智力是稀缺的**。你想做一件事，要么自己学会，要么花钱请人。这限制了每个人能做的事情的规模。

现在，**智力正在变成基础设施**。就像 100 年前电力从奢侈品变成自来水一样，AI 正在让"思考"和"执行"变得唾手可得。

这个项目是一个小小的实验：

> 如果我们把 LLM 的理解能力，和计算机的执行能力结合起来，会发生什么？

答案是：**任何人都可以拥有一支不眠不休的智能团队。**

你不需要懂编程，不需要会设计，不需要 24 小时在线。你只需要清晰地描述你想要什么，AI 会帮你实现。
